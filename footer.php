	...
	<div class="container py-md-3">
		<div class="footer-grid_section text-center">
			<div class="footer-title mb-3">
				<h2> <a href="index.html"><span></span>AARAM ENTERPRISE</a></h2>
			</div>
			<div class="footer-text">
				<p>Aaram Enterprise is a modern enterprise specializing as the distributor of home fashion 
				products like Premium Mattress, Pillows and Foam from the Brand Name Coirrlene and Sub-Brand - Crown.</p>
			</div>
		</div>
		<div class="row mt-5">
			<div class="col-lg-4 mb-lg-0 mb-4 footer-top">
				...
				<div class="footer-style-w3ls my-2">
					<p>B-35/36, Royal Township, Kandodara Road, Surat, Gujarat.</p>
				</div>
				<div class="footer-style-w3ls my-2">
					<p>9375031347/ 9829015283</p>
				</div>
				<div class="footer-style-w3ls">
					<p> <a href="mailto:info@examplemail.com">aaram4860@gmail.com</a></p>
				</div>
			</div>
...
<section class="copy-right py-4">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<p class="">© 2020 AARAM ENTERPRISE.<br> All rights reserved | Design by
